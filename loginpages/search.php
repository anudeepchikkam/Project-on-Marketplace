...
$sql="SELECT * FROM users WHERE firstname LIKE '%" . $searchQueryInput . "%'OR surname LIKE '%" . $searchQueryInput ."%'OR country LIKE '%".$searchQueryInput. "%'OR otherHobbies LIKE '%" . $searchQueryInput . "%'";  
//alert($sql);
